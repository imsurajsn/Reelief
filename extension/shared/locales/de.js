...
export default {
  ...
  'popup.stepAwayBadge': '{n}× weg',
  'popup.stepAwayTip': '{n} von {total} Aufrufen',
  'popup.avoidedBadge': '+{n}m',
  'popup.avoidedTip': 'Eigener Schnitt: {n} Min.',
  ...
  // FR-39 review nudge
  'popup.reviewTitle': "Hat es geholfen?",
  'popup.reviewBody': "Eine kurze Bewertung im Chrome Web Store hilft anderen, es zu finden.",
  'popup.reviewCta': "Bewertung schreiben",
