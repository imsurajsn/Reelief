...
export default {
  ...
  'popup.stepAwayBadge': '{n}× demi-tour',
  'popup.stepAwayTip': '{n} sur {total} ouvertures',
  'popup.avoidedBadge': '+{n}m',
  'popup.avoidedTip': 'Ta moyenne : {n} min',
  ...
  'popup.updateThrottled': 'Déjà vérifié — réessaie bientôt',
  'popup.updateError': "Impossible de vérifier pour l'instant — réessaie",
  'popup.updateReadyTitle': 'Mise à jour prête.',
  'popup.updateReadyBody': 'La version {version} est prête.',
  'popup.updateReadyCta': 'Redémarrer pour mettre à jour',
  ...
  'popup.opensLabel': 'ouvertures',
  'popup.spentLabel': 'passées',

  'popup.languageLabel': 'LANGUE',
  'popup.settingsLabel': 'PARAMÈTRES',
  'popup.moreAria': 'Plus',
  ...
  'popup.reportLabel': 'Signaler un problème',
  'popup.aboutLabel': 'À propos',
  'popup.aboutVersion': 'Version {version}',
  'popup.aboutLink': 'Voir sur GitHub',
