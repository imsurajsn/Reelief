...
export default {
  ...
  'popup.stepAwayBadge': '{n}回引き返し',
  'popup.stepAwayTip': '{total}回中{n}回',
  'popup.avoidedBadge': '+{n}m',
  'popup.avoidedTip': '自分の平均: {n}分',
  'popup.modeLabel': 'モード',
  ...
  'popup.updateThrottled': 'たった今確認しました — また後で試してください',
  'popup.updateError': '今は確認できませんでした — もう一度お試しください',
  'popup.updateReadyTitle': 'アップデートの準備ができました。',
  'popup.updateReadyBody': 'バージョン {version} の準備ができました。',
  'popup.updateReadyCta': '再起動してアップデート',
  'popup.trendLabel': '推移',
  ...
  'popup.reportLabel': '問題を報告',
  'popup.aboutLabel': 'アプリについて',
  'popup.aboutVersion': 'バージョン {version}',
  'popup.aboutLink': 'GitHubで見る',
